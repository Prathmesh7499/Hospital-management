...
<form action="admin_login" method="post">
 ...
 <div class="second">
  <br>
  <center> <h2 style="font-family: Times new roman">Admin Login...</h2></center>
  <br><br>
<div class="row">
...
<br><br>
<div class="row">
<div class="col-sm-1"><i class="fa fa-key" style="margin-left: 10px; font-size: 28px; margin-top: 35px;"></i></div>
