...
<div class="heading">
 ...
 <div class="second">
  <br>
  <center> <h2 style="font-family: Times new roman">User Login...</h2></center>
  <br><br>
<div class="row">
...
<br>
<br>
<label style="margin-left: 70px;">We have Account</label><label>&nbsp;&nbsp;&nbsp;&nbsp;<a href="user_signup.jsp" style="font-size: 15px;">Signup</a></label>
<div class="row">
