   ...
   <a class="navbar-brand" href="#"> <img src="images/image1-removebg-preview.png" style="height:70px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
          ...
          <a class="nav-link active" aria-current="page" href="Admin_homepage.jsp">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="add_doctor.jsp">ADD DOCTOR</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Doctor_list.jsp">View Dcctor</a>
        </li>
